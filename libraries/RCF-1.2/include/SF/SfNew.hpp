...
namespace SF {
    ...
    {
        RCF_THROW(RCF::Exception(RCF::_SfError_NoCtor()))(typeid(T));
        return NULL;
    }
    ...
    {
        RCF_THROW(RCF::Exception(RCF::_SfError_NoCtor()))(typeid(T[N]));
        return NULL;
    }
...
#define SF_NO_CTOR(type)                                                    \
    inline type *sfNew(type*, type **, SF::Archive &)                       \
    {                                                                       \
        RCF_THROW(RCF::Exception(RCF::_SfError_NoCtor()))(typeid(type));    \
        return NULL;                                                        \
    }
...
#define SF_NO_CTOR_T1(type)                                                 \
    ...
    {                                                                       \
        RCF_THROW(RCF::Exception(RCF::_SfError_NoCtor()))(typeid(type<T>)); \
        return NULL;                                                        \
    }
...
#define SF_NO_CTOR_T2(type)                                                 \
    ...
    {                                                                       \
    RCF_THROW(RCF::Exception(RCF::_SfError_NoCtor()))(typeid(type<T,U>));   \
        return NULL;                                                        \
    }
