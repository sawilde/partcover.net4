...
class Instrumentator
{
    ...
    ULONG32 GetFileUrlId(const std::wstring&);
...
public:
    ...
    void InstrumentModule(ModuleID module, LPCWSTR moduleName, ICorProfilerInfo* profilerInfo, ISymUnmanagedBinder2* binder);
