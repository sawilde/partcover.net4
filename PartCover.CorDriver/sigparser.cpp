...
void MethodSigWriter::NotifyTypeDefOrRef(mdToken token)
{
	...
	{
	case mdtTypeDef: 
		Append(CorHelper::GetTypedefFullName(_md, (mdTypeDef) token, NULL, L"."));
		break;
	case mdtTypeRef: 
		Append(CorHelper::TypeRefName(_md, (mdTypeRef) token));
		break;
	default: 
		Append(L"[invalidReference]");
		break;
	}
}
...
void MethodSigWriter::NotifyTypeSimple(sig_elem_type elem_type)
{
	...
	case  ELEMENT_TYPE_I1:
		Append(L"byte"); break;
	case  ELEMENT_TYPE_U1: 
		Append(L"unsigned byte"); break;
	case  ELEMENT_TYPE_I2: 
		Append(L"short"); break;
	case  ELEMENT_TYPE_U2: 
		Append(L"unsigned short"); break;
	case  ELEMENT_TYPE_I4: 
		Append(L"int"); break;
	case  ELEMENT_TYPE_U4: 
		Append(L"unsigned int"); break;
	case  ELEMENT_TYPE_I8: 
		Append(L"long"); break;
	case  ELEMENT_TYPE_U8: 
		Append(L"unsigned long"); break;
	case  ELEMENT_TYPE_R4: 
		Append(L"float"); break;
	case  ELEMENT_TYPE_R8: 
		Append(L"double"); break;
	case  ELEMENT_TYPE_I:
		Append(L"int"); break;
	case  ELEMENT_TYPE_U:
		Append(L"unsigned int"); break;
	case  ELEMENT_TYPE_STRING:
		Append(L"string"); break;
	case  ELEMENT_TYPE_OBJECT:
		Append(L"object"); break;
	default:
		Append(L"unknown"); break;
	}
}
